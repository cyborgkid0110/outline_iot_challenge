...
static BLEUUID charUUID_2("666cf2a9-49b2-4899-b4f8-61a569820707");
...
static void notifyCallback(BLERemoteCharacteristic *pBLERemoteCharacteristic, uint8_t *pData, size_t length, bool isNotify) {
  if (pBLERemoteCharacteristic->getUUID().toString() == charUUID_1.toString()) {
    ...
    Serial.print("Notify callback for characteristic 2 ");
    Serial.print(pBLERemoteCharacteristic->getUUID().toString().c_str());
    Serial.print(" of data length ");
    Serial.println(length);
    Serial.print("data: ");
...
bool connectToServer() {
  ...
  connected = true;
  if ((connectCharacteristic(pRemoteService, charUUID_1) == false)
    ||(connectCharacteristic(pRemoteService, charUUID_2) == false))
    connected = false;
